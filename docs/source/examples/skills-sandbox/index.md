...
- Text artifacts that need to survive for the current report workflow should be written through DeepAgents filesystem
  tools to `/shared/...`. This does not make them retrievable after a direct `nat run` finishes.
