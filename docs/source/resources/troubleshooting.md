...
| HTTP 429 or 503 on deep research | Nemotron Super or Nemotron Ultra hosted endpoint availability | Retry after a short delay, reduce concurrency, or self-host via [Brev Launchable](#nemotron-super--build-endpoint-availability) for consistent throughput |
