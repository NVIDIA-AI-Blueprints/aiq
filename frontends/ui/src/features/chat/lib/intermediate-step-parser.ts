 ...
 *
 * @param name - The name to check (e.g., "nvidia/nemotron-nano-3.5-preview")
 ...
 *
 * @param functionName - The raw function name (e.g., "web_search_tool", "<workflow>", "nvidia/nemotron-nano-3.5-preview")
...
export const getDisplayName = (functionName: string): string => {
  ...
  // Handle LLM model names (e.g., "nvidia/nemotron-nano-3.5-preview")
