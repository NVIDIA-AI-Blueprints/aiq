 ...
 */
const createWrapper = (
  config: AppConfig = { authRequired: true, authProviderId: 'oauth', fileUpload: defaultFileUploadConfig }
) => {
  ...
  describe('auth disabled mode', () => {
    test('returns mock authenticated user when auth is disabled', () => {
      ...
      const { result } = renderHook(() => useAuth(), {
        wrapper: createWrapper({ authRequired: false, authProviderId: 'disabled-auth', fileUpload: defaultFileUploadConfig }),
      })
