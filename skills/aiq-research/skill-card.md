...
Apache 2.0 <br>
## Use Case: <br>
Developers and engineers use this skill to submit deep research queries to a locally running NVIDIA AI-Q Blueprint server and retrieve structured research reports with citations. <br>
...
## Evaluation Tasks: <br>
Evaluated against 3 internal evaluation tasks with 2 attempts per task (NVSkills-Eval external profile, pass threshold 50%). <br>
