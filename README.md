...
| LLM (deep-research source router, orchestrator, planner, researcher) | `nvidia/nemotron-3-ultra-550b-a55b` in default profiles; GPT-OSS-120B or GPT-5.2 for selected roles in focused profiles | [Configuration Files](#configuration-files) |
...
| `config_frontier_models.yml` | GPT-5.2; Nemotron 3 Ultra; Nemotron 3 Super; Nemotron Mini summary | LlamaIndex profile using GPT-5.2 for orchestration/planning/writing, Nemotron 3 Ultra for routing/research, and Nemotron 3 Super for shallow research. Requires `OPENAI_API_KEY`. |
